  ...
  <div class="app">
    <div class="section section-header">
      <div class="container">
        ...
        <div class="menu">
          <div class="item" @click.native="onClickMenu(0)">
            <span class="active">제주</span>
          </div>
          <div class="item" @click.native="onClickMenu(1)">
            발리
          </div>
          <div class="item" @click.native="onClickMenu(2)">
            치앙마이
          </div>
        </div>
      </div>
    ...
    <div class="section-container">
      ...
      <div v-for="(play, index) in playList" :key="index" class="item">
        ...
        <div class="info">
          <div class="name">
            <span class="instalink" @click.native="goLink(play.link)">{{ play.name }}</span>
          </div>
          <div class="address">
            <a class="link" @click.native="goLink(play.address_url)" target="_blank">{{ play.address }}</a>
          </div>
          <div class="temp">-</div>
          <div class="comment">
            "{{ play.etc }}"
